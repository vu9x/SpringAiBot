...
@Service
@Log4j2
public class MailSernderGmailAuthServiceImpl implements MailSenderService {
    ...
    public MailSernderGmailAuthServiceImpl() throws GeneralSecurityException, IOException {
    ...
    @Override
    public void send(MailParams mailParams) throws MessagingException, IOException {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT, GsonFactory gsonFactory)
        ...
        GoogleClientSecrets clientSecrets =
                GoogleClientSecrets.load(gsonFactory, new InputStreamReader(
                        MailSernderGmailAuthServiceImpl.class.getResourceAsStream(
                                "/client_secret_592761881428-lokrplmvvm4j8d6f2hler72nmhcikv33.apps.googleusercontent.com.json")));
